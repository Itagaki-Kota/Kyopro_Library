...
class LowestCommonAncestor:
    def __init__(self, n):
        ...
        self._depth = [0 for _ in range(self._n)]  # 根からの辺の本数 (辺のコストは1)
        self._distance = [0 for _ in range(self._n)]  # 辺の重みを考慮した、根からのコストの総和
        # ancestor[k][v]:=頂点vから根の方向へ2^kステップ移動した頂点番号。
        self._ancestor = [
